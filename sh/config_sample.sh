...
export QYWX_AM="ww03a509cae592fa88,EPh-QXC9miV3f2UVIcuh_zaVIUCSY5EFJB8fGWtLEqo,@all,1000002"
...
## 双十一无门槛红包
export FLCODE="yKy4B8e"

## 愤怒的锦鲤
### 在kois环境变量中填入需要助力的pt_pin，有多个请用@符号连接
export kois="jd_45af13f824f4a@jd_76d60b83821e3@jd_lltyhbgFeCTQ"
...
## 清空购物车参数
export JD_CART_REMOVE="false" ## 是否清空，如果为false，则上面设置了多少就只删除多少条
export JD_CART_REMOVESIZE="20" ## 运行一次取消多全部已关注的商品。数字0表示不取关任何商品
export JD_CART_REMOVEALL="false" ## 是否清空，如果为false，则上面设置了多少就只删除多少条

## 东东世界 兑换京豆变量
### 默认999,京豆从多到少兑换，先兑换1000，1000兑换完后兑换500
### "6"只兑换1000京豆, "5"只兑换500京豆, "1"只兑换200京豆
export DDEXCHANGE="6" 
...
## 发财大赢家助力
### 邀请码变量，不支持多账号，格式：redEnvelopeId@markedPin(猜测pt_pin)
export dyjCode="9f1722f0077e455794e9164109f6cd6656131636563896821@jd_45af13f824f4a"
...
##  柠檬旺财乐园新手上路版
### 自定义邀请码变量 IANWqUmbgQVF9ePHGsGFA2m-zSTLKmHFbE-IW-Waarw
export joyinviterPin="wSbECU1ILnIMa3CrHBAC1pioljIiQgcY_mvvi9TKHss" 
...
## 早起赢现金
### 京东汽车-瓜分万元
### 支付一元才能参与活动，填写环境变量morningScPins给指定账号打卡
export morningScPins="jd_45af13f824f4a"

## 京东试用
export JD_TRY="true"

## 柠檬推一推
### 极速版赚金币 分享到QQ查看邀请码 packetId就是
export tytpacketId="f633a7deede94ca79ac81488d3f11414-amRfNDVhZjEzZjgyNGY0YQ!!"

## 入口：我的-赚30
### 备注：赚30元每日签到红包、天降红包助力，在earn30Pins环境变量中填入需要签到和接受助力的账号
### 技巧：每月可以提现100元，但需要邀请一个新人下首单。可以用已注册手机号重新注册为新人账号，切换ip可以提高成功率。
export earn30Pins="jd_45af13f824f4a"